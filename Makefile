...
export TERRAFORM_PROVIDER_SOURCE ?= goauthentik/authentik
export TERRAFORM_PROVIDER_REPO ?= https://github.com/goauthentik/terraform-provider-authentik
export TERRAFORM_PROVIDER_VERSION ?= 2024.12.0
...
xpkg.build.provider-authentik: do.build.images
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/authentiks/03-delete.yaml.tmpl.
