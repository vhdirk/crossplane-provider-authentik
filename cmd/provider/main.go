...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Authentik").DefaultEnvars()
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Authentik controllers")
